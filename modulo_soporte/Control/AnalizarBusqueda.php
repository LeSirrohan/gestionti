...
//Busqueda Simple
if($menu2==1) //Nombre
	echo"<script type='text/javascript'>document.location.href = '../Vista/Reportes_1.php';</script>";
elseif($menu2==2) //Area
  echo"<script type='text/javascript'>document.location.href = '../Vista/Reportes_5.php';</script>";
elseif($menu2==3)//Fecha
	echo"<script type='text/javascript'>document.location.href = '../Vista/Reportes_2.php';</script>";
elseif($menu2==4)//Tipo Soporte
	echo"<script type='text/javascript'>document.location.href = '../Vista/Reportes_3.php';</script>";
elseif($menu2==5)//Tecnico
	echo "<script type='text/javascript'>document.location.href = '../Vista/Reportes_4.php';</script>";
...
//Nombre Técnico
	...
	//  echo $_SESSION['_NombreTecnico'];

?>

<table width="820" align="center">
  <tr class="Estilo3">
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a target="_NEW" href="../../modulo_reportes/pdfphp/php-pgsql6.php?nombre=<?= $nombre;?>">Imprimir PDF</a></td>
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a href="../../modulo_reportes/pdfphp/php-excel6.php?nombre=<?= $nombre;?>">Imprimir Excel</a></td>
   ...
   <tr bgcolor="#99CCFF" class="Estilism">
       ...
       <td width="174"><div align="center">&Aacute;rea</div></td>
       ...
       <td width="151" align="center"><div align="center">Observaci&oacute;n</div></td>
    </tr>
      <?php 
        $soporte -> asignarNombreTecnico($nombre);
        $reg=$soporte->busqueda_nombre();
        $cantidad_registros = $soporte->cantidad_busqueda_nombre();

        if($cantidad_registros<=0)
        {

          echo "<script> alert('Disculpe usted no posee solicitudes para listar1'); </script>";      
...
//	echo $nombre." ".$area." ".$tipo." ".$fecha_inicial." ".$fecha_final;
	...
	<table width="820" align="center">
      <tr class="Estilo3">
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a href="../../modulo_reportes/pdfphp/php-pgsql7.php?fecha_inicial=<?= $fecha_inicial;?>&fecha_final=<?= $fecha_final;?>">Imprimir PDF</a></td>
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a  href="../../modulo_reportes/pdfphp/php-excel7.php?fecha_inicial=<?= $fecha_inicial;?>&fecha_final=<?= $fecha_final;?>">Imprimir Excel</a></td>
        <td colspan="2" bgcolor="#FFFFFF" align="center"><a href="../Vista/Busqueda.php">Regresar</a></td>
    ...
    $cantidad_registros = $soporte->cantidad_busqueda_fechas();
    if($cantidad_registros<=0)
    {

      echo "<script> alert('Disculpe usted no posee solicitudes para listar2'); </script>";      
        echo '<script languaje="Javascript">location.href="../Vista/Busqueda.php"</script>'; 
    }
    else 
    {
