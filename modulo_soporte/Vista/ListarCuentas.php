...
$sql2="";
while ($reg=pg_fetch_object($result))
{?>
  <tr bgcolor="#D5FFFF" class="caja">
    <td width="97" class="subbig2 Estilo1"><div align="center"><? echo $reg->login;?></div></td>
    <td width="161" class="subbig2 Estilo1"><div align="center"><? echo $reg->Nombre." ".$reg->Apellido?></div></td>
    <td width="160" class="subbig2 Estilo1"><div align="center"><? echo $reg->password;?></div></td>
    <td width="155" class="subbig2 Estilo1"><div align="center"><? echo $reg->tipo;?></div></td>
    <td width="155" class="subbig2 Estilo1"><div align="center"><? echo $reg->correo_electronico;?></div></td>
  </tr>
  <? }?>
    </table></td>
  </tr>
