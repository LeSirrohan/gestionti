...
<body onLoad="document.form1.cedulaMod.focus()">
<table width="550" border="0" align="center">
  <tr>
    <td width="600"><form id="form1" name="form1" method="post" action="../Control/AnalizarModCuen.php">
        ...
        <tr>
          <td><table width="151" border="0" align="center">
            <tr>
              ...
              <td width="98"><label>
                <input name="enviar" type="submit" id="enviar" onClick="MM_validateForm('cedulaMod','','RisNum');return document.MM_returnValue" value="Enviar" />
              </label></td>
            </tr>
          </table></td>
        </tr>
