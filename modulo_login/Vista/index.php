<?php
	...
	include("../../modulo_soporte/Control/fecha.php");
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <tr>
      <td><div align="left">
        <table width="800" height="50" border="0">
          ...
          <tr>
            <td height="22" class="bodystyle"><marquee scrollamount="3" >
    ...
    <tr>
      <td valign="top"><table width="449" height="176" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="264">          <form id="form1" name="form1" method="post" action="../Control/IniciarSesion.php">
            <table  width="349" height="152" border="0" align="center">
              ...
              <tr>
                <td colspan="2" bordercolor="0"><div align="center">
                  <input name="Iniciar" type="submit" id="Iniciar" onclick="MM_validateForm('usuario','','R','clave','','R');return document.MM_returnValue" value="Iniciar Sesion" />
                </div></td>
              </tr>
              <tr>
              ...
              <tr>
                <td colspan="2" bordercolor="0"><div align="center"><span><strong>Caicara del Orinoco, Estado Bolívar </strong><span><strong>
                  <?php $j=fecha(); ?>
